// frontend/src/services/soundService.js - ENHANCED VERSION
// FIX: Guaranteed sound stopping on emergency stop
...
class SoundService {
  ...
  // ENHANCED EMERGENCY STOP METHOD - GUARANTEED TO STOP SOUNDS
  async emergencyStop() {
    ...
    try {
      ...
      // Step 6: Force stop any remaining audio
      this.forceCleanup();
